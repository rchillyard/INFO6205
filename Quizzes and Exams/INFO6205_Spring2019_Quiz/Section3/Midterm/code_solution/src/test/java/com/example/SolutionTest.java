...
public class SolutionTest {
    ...
    public void partitionTest() {
        ...
        List<Integer> expectedList = Arrays.asList(0,1,2,9,6,10,3,5);
    ...
    public void partitionTest3(){
        ...
        List<Integer> expectedList = Arrays.asList(6,7,7,7,7,7);
        qs.partition(inputList,0,5);
        Assert.assertEquals(expectedList,inputList);
    }
    
    @Test
    public void partitionSchemeTest2() {

        List<Integer> inputList = Arrays.asList(3,2);
        List<Integer> expectedList = Arrays.asList(2,3);
        int result = qs.partition(inputList,0,1);
